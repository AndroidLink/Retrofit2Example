package com.togo.home.cucumber.pages;
...
public class LoginPage extends BasePage {
     ...
     */
    public LoginPage() {
        onView(withId(R.id.entityCell)).check(matches(isDisplayed()));
    }
...
//        onView(withId(R.id.activity_main_search)).perform(typeText(userName));
//        onView(withId(R.id.password)).perform(typeText(password), closeSoftKeyboard());
//        onView(withId(R.id.activity_main_search_button)).perform(click());
